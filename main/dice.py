...
class dice:
    ...
    def pick_your_poison(self, type_of_roll, current_player):
        ...
        if type_of_roll == "init":
            #logging.debug("pick_your_poison::Choosing initiative dice roll.")
            ...
            #logging.debug("pick_your_poison::User using a benny.")
            self.dice_dictionary = copy.deepcopy(self.last_roll)
            self.roll_them_bones("benny")
        elif type_of_roll == "dmg":
            #logging.debug("pick_your_poison::User choosing dmg roll or dmg menu.")
            ...
            #logging.debug("pick_your_poison::User rolling a trait that they current have.")
            ...
            #logging.debug("pick_your_poison::User rolling a trait that they do not currently have.")
            self.dice_dictionary["6"]+=1
            if current_player.wound_count > 0 or current_player.fat_count > 0:
                self.dice_dictionary["modifier"] += -(current_player.wound_count + current_player.fat_count)
            self.roll_them_bones("traits")
        elif type_of_roll == "soak":
            #logging.debug("pick_your_poison::User using a benny to soak a wound.")
