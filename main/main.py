...
def death_banner():
    ...
    print("\n" * 2)
    time.sleep(3)
    print("                       `:oyhdmmNMMNNNmdy+-        ")
    print("                    `+dMMMMMMMMMMMMMMMMMMMNs:     ")
    print("                  `oNMMMMMMMMMMMMMMMMMMMMMMMMd:   ")
    print("                 :mMMMMMMMMMMMMMMMMMMMMMMMMMMMMy` ")
    print("                +MMMMyNMMMMMMMMMMMMMMMMMMMMMMMMMd`")
    print("               :MMMM/dMMMMMMMMMMMMMMMMMMMMMMMMMMMs")
    print("               dMMM++MMMMMMMMMMMMMMMMMMMMMMMMMMMMN")
    print("               MMM++NMMMMMMMMMMMMMMMMMMMMMMMMMMMMM")
    print("               MMN`NMMMMNmmNMMMMMMMMMMmmNMMMMMMMMM")
    print("               mMN-MMMd/.``.:hMMMMMd+.``.+mMMMNMMm")
    print("               sMM:MMm`      `NMMMm`      -NMNoMMy")
    print("               `dN-MMs       -MMMMN.       hMh/MN:")
    print("                .++MMy     .oNMNyMMm/`    `hMh.+- ")
    print("               .hmNMMMs//ohmMMN- yMMMd+::odMMMhs: ")
    print("               -NMMMMMMMMMMMMM/  -MMMMMMMMMMMMMMd ")
    print("                -sdNMMMMMMMMMN....dMMMMMMMMMMNms. ")
    print("                   .:+yNMMMMMMmNNNNMMMMMMNds+-`   ")
    print("                    ..`.yMMMMMMMMMMMMMMMh:``      ")
    print("                    dMd: :yNNNNMMMNMMmh//hdh      ")
    print("                    yMMN. omsmdMdNdyN` :MMMs      ")
    print("                    sMMM/ -o/sshohy:o  hMMM.      ")
    print("                    +MMMh .-.-``` ``  -MMMN       ")
    print("                    .mMMMhsNhMsNd dN`:mMMMs       ")
    print("                     `oNMMMNdmymhydmNMMMMs        ")
    print("                       -mMMMMMMMMMMMMMMd:         ")
    print("                         /hmNMMMMNNNmy:           ")
    print("\n" * 7)
    ...
    while True:
        ...
        if not sanitize_user_input(dice_roll):
            ...
            # To exit game
                ...
                # FIXME: needs to reload character sheet into memory
